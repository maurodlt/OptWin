...
RESULT_DIR=$OPTWIN_PATH"/MOA_experiments/results/gradual_binary/"
N_TOTAL=30
...
COMMAND2=") -s (GradualChangeGenerator -c 0.001 -i "
COMMAND3=" -p 2000) -i 10000 -f 1 -d "
COMMAND4="_gradual_binary.csv"
